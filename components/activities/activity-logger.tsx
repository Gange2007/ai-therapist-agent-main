  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!type || !name) {
      toast({
        ...
        description: "Please select an activity type and enter a name",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      await logActivity({
        ...
        name,
        description,
        // Always send a number — default to 0 if left blank
        duration: duration.trim() !== "" ? parseInt(duration, 10) : 0,
      });
